...
class scraper:
    def __init__(self, PROJECT_ID, DATASET, TABLE_NAME, SERVICE_ACCOUNT):
        ...
        self.url = "https://techcrunch.com/wp-json/tc/v1/magazine?"
        ...
        self.cols = {
            ...
            # "yoast_head_json.description": "post_description",  # sometimes got null
            ...
            "primary_category.term_id": "category",  # need to find further
